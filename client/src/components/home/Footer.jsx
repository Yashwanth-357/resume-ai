    ...
    <div className="bg-black pt-20 px-4">
      <footer className="bg-white w-full max-w-[1350px] mx-auto text-black pt-8 lg:pt-12 px-4 sm:px-8 md:px-16 lg:px-28 rounded-tl-3xl rounded-tr-3xl overflow-hidden">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-6 gap-8 md:gap-12">
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="flex gap-5 md:gap-6 order-1 md:order-2">
              ...
              {/* Github */}
              <a href="https://github.com/Yashwanth-357" className="text-neutral-600 hover:text-neutral-700">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="20"
              ...
              {/* Linkedin */}
              <a href="https://www.linkedin.com/in/yashwanth357/" className="text-neutral-600 hover:text-neutral-700">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="20"
          ...
          <div className="lg:col-span-3  gap-8 md:gap-12 lg:gap-28 items-start flex justify-around">
            {/* Products */}
            <div>
        ...
        <div className="max-w-7xl mx-auto mt-12 pt-4 border-t border-neutral-300 flex justify-between items-center">
          <p className="text-neutral-600 text-sm">© 2025 Resume Builder</p>
          <p className="text-sm text-neutral-600">All right reserved.</p>
        </div>
        <div className="relative">
          <div className="absolute inset-x-0 bottom-0 mx-auto w-full max-w-3xl h-full max-h-64 bg-gradient-to-r from-white via-indigo-500 to-white rounded-full blur-[100px] pointer-events-none" />
