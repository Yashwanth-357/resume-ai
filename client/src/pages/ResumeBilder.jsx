...
const ResumeBilder = () => {
  ...
  const handleShare = async () => {
    ...
    try {
      ...
      // final fallback
      window.prompt("Copy this link to share:", resumeUrl);
    } catch (err) {
      console.error("Share failed", err);
      alert("Unable to share. Copy the link manually: " + resumeUrl);
    }
  };
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1">
              {/* progress br using activeSectionIndex */}
              <hr className="absolute top-0 left-0 ring-0 border-2 border-gray-200" />
              <hr
                className="absolute top-0 left-0 h-1 bg-gradient-to-r from-indigo-500 to-green-600 border-none transition-all duration-2000"
                style={{
